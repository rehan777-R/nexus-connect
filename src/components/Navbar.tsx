  ...
  return (
    <nav className="navbar">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <div style={{ width: '22px', height: '22px', borderRadius: '6px', background: 'var(--accent-grad)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {currentUser ? (
          <>
            <Link to="/profile" title="Your profile" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
              <div style={{ width: '28px', height: '28px', borderRadius: '50%', background: userProfile?.avatarColor || '#6366F1', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '12.5px', fontWeight: 700 }}>
          ...
          <>
            ...
            <Link to="/signup" style={{ padding: '8px 16px', background: 'var(--accent-grad)', color: 'white', borderRadius: '8px', textDecoration: 'none', fontWeight: 500, fontSize: '13.5px', whiteSpace: 'nowrap' }}>Sign up</Link>
          </>
        )}
        <button
